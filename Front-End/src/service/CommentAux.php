...
class  CommentAux
{
    ...
    foreach ($comentarios as $comentario) {
        ...
        $html .= "<p class='p-resposta-comentario' ><strong> {$comentario->username}:</strong> " . htmlspecialchars($comentario->comment) . "</p>";
        ...
        if (!empty($comentario->getRespostas())) {
            ...
            $html .= "<button class='botao-inferior-direito'>Responder</button>";
        $html .= "</div>";
    }
    return $html;
}
